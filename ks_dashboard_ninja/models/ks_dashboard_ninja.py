...
class KsDashboardNinjaBoard(models.Model):
    ...
    def _update_boolean_vals(self, data: str) -> str:
        ...
        for row in rows:
            updated_data = []
            for index, n in enumerate(row['data']):
                if types[index] == 'boolean' and n == True:
                    n = 'نعم'
                    updated_data.append(n)
                elif types[index] == 'boolean' and n == False:
                    n = 'لا'
                    updated_data.append(n)
                else:
                    updated_data.append(n)
    ...
    def ks_fetch_item(self, item_list, ks_dashboard_id, params={}):
        ...
        for item_id in item_list:
            ...
            item['ks_list_view_data'] = self._update_boolean_vals(item['ks_list_view_data'])
            items[item['id']] = item
        return items
