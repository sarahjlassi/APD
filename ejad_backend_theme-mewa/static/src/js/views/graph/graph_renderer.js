...
const __themesDB = require('ejad_backend_theme-mewa.ejadWebThemes');
const session = require('web.session');
const userTheme = __themesDB.get_theme_config_by_uid(session.uid);
import { patch } from 'web.utils';

patch(GraphRenderer.prototype, '@ejad_backend_theme-mewa/static/src/js/views/graph/graph_renderer.js', {
    renderChart() {
