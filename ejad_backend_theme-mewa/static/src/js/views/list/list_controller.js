odoo.define('ejad_backend_theme-mewa.ListController', function(require) {
    "use strict";
    ...
    var CustomizeList = Dialog.extend({
        ...
        _onChangeView: function(ev) {
            ...
            this.$('.o_density_image img').attr('src', '/ejad_backend_theme-mewa/static/src/img/' + this.default_density + '.png')
        },
    ...
    ListController.include({
        ...
        willStart: function() {
            ...
            const acl = this.getSession().user_has_group('ejad_backend_theme-mewa.group_display_density').then(hasGroup => {
        ...
        _update: async function() {
            ...
            if (!config.device.isMobile) { this.$el.removeClass('o_open_sidebar'); };
        },
