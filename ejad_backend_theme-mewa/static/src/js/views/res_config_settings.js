odoo.define('ejad_backend_theme-mewa.settings', function(require) {
    "use strict";
    ...
    BaseSettingRenderer.Renderer.include({
        ...
        _getAppIconUrl: function(module) {
            ...
            if (this.meniIcon === 'base_icon') {
                ...
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/menu_2d/';
                ...
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/menu/';
                if (this.fileExists(custom_icon_path + module + '.png')) {
                    path = custom_icon_path + module + ".png"
                } else {
                    path = custom_icon_path + "/custom.png";
            ...
            else if(this.meniIcon === 'colors_icon'){
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/colors/';
                if(this.fileExists(custom_icon_path + module+'.png')){
                    path= custom_icon_path + module+".png"
                }else{
                    path = custom_icon_path +"/custom.png";
            ...
            else if(this.meniIcon === 'green_icon'){
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/green/';
                if(this.fileExists(custom_icon_path + module+'.png')){
                    path= custom_icon_path + module+".png"
                }else{
                    path = custom_icon_path +"/custom.png";
            ...
            else if(this.meniIcon === 'blue_icon'){
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/blue/';
                if(this.fileExists(custom_icon_path + module+'.png')){
                    path= custom_icon_path + module+".png"
                }else{
                    path = custom_icon_path +"/custom.png";
            ...
            else if(this.meniIcon === 'dark_blue_icon'){
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/dark_blue/';
                if(this.fileExists(custom_icon_path + module+'.png')){
                    path= custom_icon_path + module+".png"
                }else{
                    path = custom_icon_path +"/custom.png";
            ...
            else if(this.meniIcon === 'light_blue_icon'){
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/light_blue/';
                if(this.fileExists(custom_icon_path + module+'.png')){
                    path= custom_icon_path + module+".png"
                }else{
                    path = custom_icon_path +"/custom.png";
            ...
            else if(this.meniIcon === 'blue_with_border_icon'){
                custom_icon_path = '/ejad_backend_theme-mewa/static/src/img/blue_with_border/';
                if(this.fileExists(custom_icon_path + module+'.png')){
                    path= custom_icon_path + module+".png"
                }else{
                    path = custom_icon_path +"/custom.png";
