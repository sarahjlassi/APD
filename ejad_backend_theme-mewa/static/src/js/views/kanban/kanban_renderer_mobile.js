/**
 * Copied from odoo-13/addons/web/static/src/js/views/kanban/kanban_renderer_mobile.js - [CE]community edition
 * dated: 15th, January, 2021
 *
 * Modified on 19th, January, 2021 - Update mobile tag click event `_moveToGroup` code.
 */
